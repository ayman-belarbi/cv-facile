...
const ResumeForm = ({ resumeData, setResumeData }) => {
  ...
  return (
    <div className="space-y-4">
      <CVCompleteness resumeData={resumeData} />
      
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <ColorPicker
          selectedScheme={
            Object.entries(colorSchemes).find(
              ([_, scheme]) => scheme.primary === resumeData.settings?.colorScheme?.primary
            )?.[0] || 'sapphire'
          }
        ...
        <FontPicker
          selectedFont={resumeData.settings?.font || "Inter"}
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="flex items-center pt-8">
                  <input
                    ...
                    className="w-4 h-4 mr-2 border-gray-300 dark:border-slate-600 rounded"
                  />
            ...
            <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-slate-700 rounded-md focus:outline-none focus:ring-2 focus:ring-cvfacile-primary
              ...
              {!resumeData.skills || !Array.isArray(resumeData.skills) || resumeData.skills.length === 0 ? (
                ...
                <div className="space-y-2">
                  {resumeData.skills.map((skill) => (
                    <div key={skill.id} className="flex items-center justify-between p-3 border border-gray-200 dark:border-slate-700 rounded-lg">
              ...
              {!resumeData.languages || !Array.isArray(resumeData.languages) || resumeData.languages.length === 0 ? (
                ...
                <div className="space-y-2">
                  {resumeData.languages.map((language) => (
                    <div key={language.id} className="flex items-center justify-between p-3 border border-gray-200 dark:border-slate-700 rounded-lg">
                      <div>
              ...
              {!resumeData.certifications || !Array.isArray(resumeData.certifications) || resumeData.certifications.length === 0 ? (
                ...
                <div className="space-y-2">
                  {resumeData.certifications.map((cert) => (
                    <div key={cert.id} className="flex items-center justify-between p-3 border border-gray-200 dark:border-slate-700 rounded-lg">
                      <div>
